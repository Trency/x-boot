...
public class SdLoanPushMessage extends BaseEntity {
    ...
    private String pushMessageType;        // 推送类型, 应用程序自定义
    private String title;        // 标题, 对应属于 alert
    private String message;        // 内容
    private String extras;        // 附加信息, 建议使用json 存储
    private String registrationId;        // 第三方推送注册ID
    private String platformType;        // 推送平台, IOS-苹果 | ANDROID-安卓
    private String readStatus;        // 阅读状态, UN_READ-未读 | READ-已读
    private String pushStatus;        // 推送状态, UN_PUSH-未推送 | PUSHED-已推送
    private String errorMsg;        // 错误信息
    private String asyncId;        // 异步ID, 可查推送状态
